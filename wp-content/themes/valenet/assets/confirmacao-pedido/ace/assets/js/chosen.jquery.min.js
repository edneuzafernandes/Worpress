...
.call(this), function () {
	...
	AbstractChosen = function () {
		...
		AbstractChosen.default_multiple_text = "Selecione um ou mais itens",
		AbstractChosen.default_single_text = "Selecione um item",
...
.call(this), function () {
	...
	Chosen = function (d) {
		...
		Chosen.prototype.result_deselect = function (b) {
			...
			this.form_field.options[d.options_index].disabled ? !1 : (d.selected = !1, this.form_field.options[d.options_index].selected = !1, this.selected_option_count = null, c = a("#" + this.container_id + "_o_" + b), c.removeClass("result-selected").addClass("active-result").show(), this.result_clear_highlight(), this.winnow_results(), this.form_field_jq.trigger("change", {
		        ...
		        case 9:
		            ...
		            if (this.results_showing) {
		                if (this.result_highlight) {
		                    ...
		                    if ($(this.form_field).data('allownew')) {
		                        $(this.form_field).append('<option selected value="0">' + $(a.target).val() + '</option>');
		                        $(this.form_field).trigger('liszt:updated');
		                        $(this.form_field).trigger('liszt:newitem');
		                        $(this.form_field).val(0);
