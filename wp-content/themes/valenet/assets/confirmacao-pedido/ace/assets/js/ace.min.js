...
function handle_side_menu() {
    ...
    $(".nav-list").on(ace.click_event, function (g) {
        ...
        if (!$(d).is(":visible")) {
            ...
            if (b && c.hasClass("nav-list") /* && $($(d).parent()).parent().attr('id') != "barraMonitoramentoOS"*/) {
                return
            }
        ...
        if (b && $(d.parentNode.parentNode).hasClass("nav-list") /*&& $($(d).parent()).parent().attr('id') != "barraMonitoramentoOS"*/) {
            return false
        }
