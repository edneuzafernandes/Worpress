!function (b) {
    var a = function (k, s, i) {
        ...
        this.locale = {
            ...
            daysOfWeek: 'Do_Seg_Ter_Qua_Qui_Sex_Sab'.split('_'),//moment()._lang._weekdaysMin,
            monthNames: 'Jan_Fev_Mar_Abr_Mai_Jun_Jul_Ago_Set_Out_Nov_Dez'.split('_'),//moment()._lang._monthsShort,
            firstDay: 0
        };
        f = this.locale;
        this.leftCalendar = {
    ...
    a.prototype = {
        ...
        notify: function () {
            ...
            var d = (this.cleared ? null : this.startDate),
			c = (this.cleared ? null : this.endDate);
            this.cleared = false;
            this.cb(d, c)
        },
        move: function () {
