				...
				for (var E, S = t.slidesPerColumn, C = x / S, M = Math.floor(d / t.slidesPerColumn), k = 0; k < d; k += 1) {
					...
					if ("none" !== P.css("display")) {
						if ("auto" === t.slidesPerView) {
							...
							T = (i - (t.slidesPerView - 1) * g) / t.slidesPerView, t.roundLengths && (T = Math.floor(T)), l[k] && (e.isHorizontal() ? l[k].style.width = T + "px" : l[k].style.height = T + "px");
	...
	S = function (u) {
		function h() {
			for (var e, t, s, a = [], i = arguments.length; i--; )
				a[i] = arguments[i];
			(s = 1 === a.length && a[0].constructor && a[0].constructor === Object ? a[0] : (t = (e = a)[0], e[1])) || (s = {}),
			s = ee.extend({}, s),
			t && !s.el && (s.el = t),
			u.call(this, s),
...
(function (o) {
	var i = function (c, y, M) {
		var b = {
			...
			getCaret: function () {
				try {
					...
					s = e.selectionStart;
					return n && -1 === navigator.appVersion.indexOf("MSIE 10") ? ((t = n.createRange()).moveStart("character", -b.val().length), a = t.text.length) : (s || "0" === s) && (a = s),
					a
				} catch (t) {}
			},
			setCaret: function (t) {
			...
			events: function () {
				c.on("keydown.mask", function (t) {
					...
					c.data("mask-previus-caret-pos", b.getCaret()),
					...
					r === b.val() || c.data("changed") || c.trigger("change"),
					c.data("changed", !1)
				}).on("blur.mask", function () {
					r = b.val()
			...
			getRegexMask: function () {
				for (var t, a, e, n, s = [], r = 0; r < y.length; r++)
					(t = j.translation[y.charAt(r)]) ? (a = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""), e = t.optional, (t = t.recursive) ? (s.push(y.charAt(r)), n = {
								digit: y.charAt(r),
								pattern: a
							}) : s.push(e || t ? a + "?" : a)) : s.push(y.charAt(r).replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
				return s = s.join(""),
				n && (s = s.replace(new RegExp("(" + n.digit + "(.*" + n.digit + ")?)"), "($1)?").replace(new RegExp(n.digit, "g"), n.pattern)),
				new RegExp(s)
			},
			...
			calculateCaretPosition: function () {
				...
				if (t !== a) {
					...
					i = 0,
					l = 0;
					for (n = e; n < a && b.maskDigitPosMap[n]; n++)
						o++;
					for (n = e - 1; 0 <= n && b.maskDigitPosMap[n]; n--)
						t++;
					for (n = e - 1; 0 <= n; n--)
						b.maskDigitPosMap[n] && i++;
					for (n = s - 1; 0 <= n; n--)
						b.maskDigitPosMapOld[n] && l++;
			...
			getMasked: function (t, a) {
				...
				return o = y.charAt(e),
				l !== u + 1 || j.translation[o] || r.push(o),
				r = r.join(""),
				b.mapMaskdigitPositions(r, h, u),
				r
			},
			mapMaskdigitPositions: function (t, a, e) {
				for (t = M.reverse ? t.length - e : 0, b.maskDigitPosMap = {}, e = 0; e < a.length; e++)
					b.maskDigitPosMap[a[e] + t] = 1
			},
			callbacks: function (t) {
				...
				s("onChange", !0 === e, n),
				s("onKeyPress", !0 === e, n),
				s("onComplete", a.length === y.length, n),
				s("onInvalid", 0 < b.invalid.length, [a, t, c, b.invalid, M])
			}
		};
		c = o(c);
		var n,
		j = this,
		r = b.val();
		y = "function" == typeof y ? y(b.val(), void 0, c, M) : y,
		j.mask = y,
		j.options = M,
		j.remove = function () {
			var t = b.getCaret();
			return j.options.placeholder && c.removeAttr("placeholder"),
			c.data("mask-maxlength") && c.removeAttr("maxlength"),
			b.destroyEvents(),
			b.val(j.getCleanVal()),
			b.setCaret(t),
			c
		...
		j.init = function (t) {
			if (t = t || !1, M = M || {}, j.clearIfNotMatch = o.jMaskGlobals.clearIfNotMatch, j.byPassKeys = o.jMaskGlobals.byPassKeys, j.translation = o.extend({}, o.jMaskGlobals.translation, M.translation), j = o.extend(!0, {}, j, M), n = b.getRegexMask(), t)
				...
				a && c.attr("maxlength", y.length).data("mask-maxlength", !0),
				b.destroyEvents(),
				b.events(),
				t = b.getCaret(),
				b.val(b.getMasked()),
	...
	t = function (t) {
		...
		return (a = (t = "on" + t)in e) || (e.setAttribute(t, "return;"), a = "function" == typeof e[t]),
		a
	};
	o.fn.mask = function (t, a) {
		...
		r = function () {
			if (l(this, t, a))
				return o(this).data("mask", new i(this, t, a))
		};
		return o(this).each(r),
		e && "" !== e && s && (clearInterval(o.maskWatchers[e]), o.maskWatchers[e] = setInterval(function () {
	...
	o.fn.unmask = function () {
		return clearInterval(o.maskWatchers[this.selector]),
	...
	(t = o.jMaskGlobals = o.extend(!0, {}, t, o.jMaskGlobals)).dataMask && o.applyDataMask(),
	...
	!function (z) {
		...
		function k(e, t, i, s) {
			for (var n = ["display", "subtext", "tokens"], o = !1, r = 0; r < n.length; r++) {
				var l = n[r],
				a = e[l];
				if (a && (a = a.toString(), "display" === l && (a = a.replace(/<[^>]+>/g, "")), s && (a = w(a)), a = a.toUpperCase(), o = "contains" === i ? 0 <= a.indexOf(t) : a.startsWith(t)))
					break
			}
			return o
		}
		...
		Z = function (e) {
			...
			return e.subtext && ((t = F.subtext.cloneNode(!1)).textContent = e.subtext, s.appendChild(t)),
			F.fragment.appendChild(s),
			F.fragment
		},
		J = function (e, t) {
			...
			var s = this.each(function () {
					...
					if (e.is("select")) {
						...
						if (t) {
							...
							r.template = z.extend({}, J.DEFAULTS.template, z.fn.selectpicker.defaults ? z.fn.selectpicker.defaults.template : {}, n.template, i.template),
		...
		J.prototype = {
			...
			createDropdown: function () {
				...
				l = "",
				a = "";
				return this.options.header && (o = '<div class="' + j.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
				this.options.liveSearch && (r = '<div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + E(this.options.liveSearchPlaceholder) + '"') + ' role="combobox" aria-label="Search" aria-controls="' + this.selectId + '" aria-autocomplete="list"></div>'),
				...
				this.multiple && this.options.doneButton && (a = '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm ' + j.BUTTONCLASS + '">' + this.options.doneButtonText + "</button></div></div>"),
				n = '<div class="dropdown bootstrap-select' + e + i + '"><button type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + ("static" === this.options.display ? 'data-display="static"' : "") + 'data-toggle="dropdown"' + s + ' role="combobox" aria-owns="' + this.selectId + '" aria-haspopup="listbox" aria-expanded="false"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner"></div></div> </div>' + ("4" === M.major ? "" : '<span class="bs-caret">' + this.options.template.caret + "</span>") + '</button><div class="' + j.MENU + " " + ("4" === M.major ? "" : j.SHOW) + '">' + o + r + l + '<div class="inner ' + j.SHOW + '" role="listbox" id="' + this.selectId + '" tabindex="-1" ' + t + '><ul class="' + j.MENU + " inner " + ("4" === M.major ? j.SHOW : "") + '" role="presentation"></ul></div>' + a + "</div></div>",
				z(n)
			},
			...
			createView: function (A, e, t) {
				...
				function l(e, t) {
					...
					!0 === m && D.sizeInfo.hasScrollBar && D.$menu[0].offsetWidth > D.sizeInfo.totalMenuWidth && (D.sizeInfo.menuWidth = D.$menu[0].offsetWidth, D.sizeInfo.totalMenuWidth = D.sizeInfo.menuWidth + D.sizeInfo.scrollBarWidth, D.$menu.css("min-width", D.sizeInfo.menuWidth)),
					...
					if (void 0 === r && (r = 0), l = [D.selectpicker.view.position0, D.selectpicker.view.position1], n = Math.max(0, r - 1), o = Math.min(s - 1, r + 1), D.selectpicker.view.position0 = !1 === m ? 0 : Math.max(0, u[n][0]) || 0, D.selectpicker.view.position1 = !1 === m ? p : Math.min(p, u[o][1]) || 0, a = l[0] !== D.selectpicker.view.position0 || l[1] !== D.selectpicker.view.position1, void 0 !== D.activeIndex && (N = D.selectpicker.main.elements[D.prevActiveIndex], H = D.selectpicker.main.elements[D.activeIndex], L = D.selectpicker.main.elements[D.selectedIndex], t && (D.activeIndex !== D.selectedIndex && D.defocusItem(H), D.activeIndex = void 0), D.activeIndex && D.activeIndex !== D.selectedIndex && D.defocusItem(L)), void 0 !== D.prevActiveIndex && D.prevActiveIndex !== D.activeIndex && D.prevActiveIndex !== D.selectedIndex && D.defocusItem(N), (t || a) && (c = D.selectpicker.view.visibleElements ? D.selectpicker.view.visibleElements.slice() : [], D.selectpicker.view.visibleElements = !1 === m ? D.selectpicker.current.elements : D.selectpicker.current.elements.slice(D.selectpicker.view.position0, D.selectpicker.view.position1), D.setOptionStatus(), (A || !1 === m && t) && (d = c, h = D.selectpicker.view.visibleElements, f = !(d.length === h.length && d.every(function (e, t) {
						...
						for (var S = $.length; v < S; v++) {
							...
							C,
							O = $[v];
							D.options.sanitize && (E = O.lastChild) && (C = D.selectpicker.current.data[v + D.selectpicker.view.position0]) && C.content && !C.sanitized && (y.push(E), C.sanitized = !0),
							x.appendChild(O)
						}
						D.options.sanitize && y.length && P(y, D.options.whiteList, D.options.sanitizeFn),
						I.firstChild.style.marginBottom = !0 === m ? (b = 0 === D.selectpicker.view.position0 ? 0 : D.selectpicker.current.data[D.selectpicker.view.position0 - 1].position, w = D.selectpicker.view.position1 > p - 1 ? 0 : D.selectpicker.current.data[p - 1].position - D.selectpicker.current.data[D.selectpicker.view.position1 - 1].position, I.firstChild.style.marginTop = b + "px", w + "px") : I.firstChild.style.marginTop = 0,
			...
			createLi: function () {
				...
				!c.options.showTick && !c.multiple || F.checkMark.parentNode || (F.checkMark.className = f + " " + c.options.tickIcon + " check-mark", F.a.appendChild(F.checkMark));
				...
				function I(e, t) {
					if ((t = t || {}).divider = "true" === e.getAttribute("data-divider"), t.divider)
						...
						t.icon && (a += 1),
						d < a && (d = a, c.selectpicker.view.widestOption = v[v.length - 1])
					}
				}
				function i(e, t) {
					var i = t[e],
			...
			render: function () {
				...
				d = !1;
				if (r.classList.toggle("bs-placeholder", i.multiple ? !o : !O(s, n)), this.tabIndex(), "static" === this.options.selectedTextFormat)
					c = Y({
					...
					for (var h = 0; h < o && h < 50; h++) {
						...
						p.title ? u.text = p.title : f.content && i.options.showContent ? (u.content = f.content.toString(), d = !0) : (i.options.showIcon && (u.icon = f.icon, u.iconBase = this.options.iconBase), i.options.showSubtext && !i.multiple && f.subtext && (u.subtext = " " + f.subtext), u.text = p.textContent.trim()),
						c.appendChild(Y(u, !0))
					}
			...
			setStyle: function (e, t) {
				...
				M.major < 4 && (n.classList.add("bs3"), n.parentNode.classList.contains("input-group") && (n.previousElementSibling || n.nextElementSibling) && (n.previousElementSibling || n.nextElementSibling).classList.contains("input-group-addon") && n.classList.add("bs3-has-addon")),
				i = e ? e.trim() : o,
			...
			setMenuSize: function (e) {
				...
				v = 0;
				if (this.options.dropupAuto && (l = c * this.selectpicker.current.elements.length + m.vert, this.$newElement.toggleClass(j.DROPUP, this.sizeInfo.selectOffsetTop - this.sizeInfo.selectOffsetBot > this.sizeInfo.menuExtras.vert && l + this.sizeInfo.menuExtras.vert + 50 > this.sizeInfo.selectOffsetBot)), "auto" === this.options.size)
			...
			setSize: function (e) {
				if (this.liHeight(e), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size) {
					...
					"auto" === this.options.size ? i.off("resize" + U + "." + this.selectId + ".setMenuSize scroll" + U + "." + this.selectId + ".setMenuSize").on("resize" + U + "." + this.selectId + ".setMenuSize scroll" + U + "." + this.selectId + ".setMenuSize", function () {
						return t.setMenuSize()
					}) : this.options.size && "auto" != this.options.size && this.selectpicker.current.elements.length > this.options.size && i.off("resize" + U + "." + this.selectId + ".setMenuSize scroll" + U + "." + this.selectId + ".setMenuSize"),
					t.createView(!1, !0, e)
				}
			},
			setWidth: function () {
			...
			selectPosition: function () {
				...
				e = function (e) {
					...
					r.$bsContainer.addClass(e.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(j.DROPUP, e.hasClass(j.DROPUP)),
					s = e.offset(),
					l.is("body") ? n = {
						top: 0,
						left: 0
					}
					 : ((n = l.offset()).top += parseInt(l.css("borderTopWidth")) - l.scrollTop(), n.left += parseInt(l.css("borderLeftWidth")) - l.scrollLeft()),
			...
			setDisabled: function (e, t) {
				...
				i && ("4" === M.major && i.classList.toggle(j.DISABLED, t), t ? (i.setAttribute("aria-disabled", t), i.setAttribute("tabindex", -1)) : (i.removeAttribute("aria-disabled"), i.setAttribute("tabindex", 0)))
			},
			isDisabled: function () {
			...
			checkDisabled: function () {
				var e = this;
				this.isDisabled() ? (this.$newElement[0].classList.add(j.DISABLED), this.$button.addClass(j.DISABLED).attr("tabindex", -1).attr("aria-disabled", !0)) : (this.$button[0].classList.contains(j.DISABLED) && (this.$newElement[0].classList.remove(j.DISABLED), this.$button.removeClass(j.DISABLED).attr("aria-disabled", !1)), -1 != this.$button.attr("tabindex") || this.$element.data("tabindex") || this.$button.removeAttr("tabindex")),
			...
			clickListener: function () {
				...
				this.$menuInner.on("click", "li a", function (e, t) {
					...
					if (C.multiple && 1 !== C.options.maxOptions && e.stopPropagation(), e.preventDefault(), !C.isDisabled() && !i.parent().hasClass(j.DISABLED)) {
							...
							if (p.selected = !f, C.setSelected(r, !f), i.trigger("blur"), !1 !== g || !1 !== b) {
								...
								if (g && w || b && I)
									if (g && 1 == g) {
										...
										$[2] && (y = y.replace("{var}", $[2][1 < g ? 0 : 1]), S = S.replace("{var}", $[2][1 < b ? 0 : 1])),
										u.prop("selected", !1),
										C.$menu.append(E),
										g && w && (E.append(z("<div>" + y + "</div>")), d = !1, C.$element.trigger("maxReached" + U)),
										b && I && (E.append(z("<div>" + S + "</div>")), d = !1, C.$element.trigger("maxReachedGrp" + U)),
										setTimeout(function () {
											C.setSelected(r, !1)
										}, 10),
						...
						d && (C.multiple || a !== s.selectedIndex) && (T = [p.index, u.prop("selected"), l], C.$element.triggerNative("change"))
					}
				}),
				...
				this.$searchbox.on("input propertychange", function () {
					...
					if (u.selectpicker.search.elements = [], u.selectpicker.search.data = [], e) {
						...
						for (var l = 0; l < u.selectpicker.main.data.length; l++) {
							...
							s[l] || (s[l] = k(a, i, o, r)),
							s[l] && void 0 !== a.headerIndex && -1 === n.indexOf(a.headerIndex) && (0 < a.headerIndex && (s[a.headerIndex - 1] = !0, n.push(a.headerIndex - 1)), s[a.headerIndex] = !0, n.push(a.headerIndex), s[a.lastIndex + 1] = !0),
						...
						u.createView(!0),
						t.length || (f.className = "no-results", f.innerHTML = u.options.noneResultsText.replace("{0}", '"' + E(e) + '"'), u.$menuInner[0].firstChild.appendChild(f))
					} else
			...
			changeAll: function (e) {
				if (this.multiple) {
					...
					i !== s && (this.setOptionStatus(), T = [null, null, n], this.$element.triggerNative("change"))
				}
			},
			selectAll: function () {
			...
			keydown: function (e) {
				...
				if (!(i = a.$newElement.hasClass(j.SHOW)) && (p || 48 <= e.which && e.which <= 57 || 96 <= e.which && e.which <= 105 || 65 <= e.which && e.which <= 90) && (a.$button.trigger("click.bs.dropdown.data-api"), a.options.liveSearch))
					...
					if (e.which === L && i && (e.preventDefault(), a.$button.trigger("click.bs.dropdown.data-api").trigger("focus")), p) {
						...
						e.which === B ? (-1 !== t && t--, t + f < 0 && (t += c.length), a.selectpicker.view.canHighlight[t + f] || -1 === (t = a.selectpicker.view.canHighlight.slice(0, t + f).lastIndexOf(!0) - f) && (t = c.length - 1)) : (e.which === W || h) && (++t + f >= a.selectpicker.view.canHighlight.length && (t = 0), a.selectpicker.view.canHighlight[t + f] || (t = t + 1 + a.selectpicker.view.canHighlight.slice(t + f + 1).indexOf(!0))),
						e.preventDefault();
						var m = f + t;
						e.which === B ? 0 === f && t === c.length - 1 ? (a.$menuInner[0].scrollTop = a.$menuInner[0].scrollHeight, m = a.selectpicker.current.elements.length - 1) : d = (o = (n = a.selectpicker.current.data[m]).position - n.height) < u : (e.which === W || h) && (0 === t ? m = a.$menuInner[0].scrollTop = 0 : d = u < (o = (n = a.selectpicker.current.data[m]).position - a.sizeInfo.menuInnerHeight)),
...
function share_wpp(a) {
	var e = screen.height,
	n = screen.width;
	window.open("https://api.whatsapp.com/send?text=" + a, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=0,left=0,width=" + n + ",height=" + e)
}
$(document).on("click", ".btn-menu-responsive", function (a) {
	$(this).addClass("openMenu"),
	$(".body-menu-responsive").addClass("body-menu-responsive-open"),
	$("body").addClass("menu-ativo"),
	$("html").css("overflow-x", "unset")
}), $(document).on("click", ".openMenu", function (a) {
	$(this).removeClass("openMenu"),
	$(".body-menu-responsive").removeClass("body-menu-responsive-open"),
	$("body").removeClass("menu-ativo"),
	$("html").css("overflow-x", "hidden")
}), $(window).scroll(function () {
	50 < $(this).scrollTop() ? $("#menu-site").addClass("fixed-top menu-scroll") : $("#menu-site").removeClass("fixed-top menu-scroll")
});
var SPMaskBehavior = function (a) {
	return 11 === a.replace(/\D/g, "").length ? "(00) 00000-0000" : "(00) 0000-00009"
}, spOptions = {
	onKeyPress: function (a, e, n, t) {
		n.mask(SPMaskBehavior.apply({}, arguments), t)
	}
};
$(".telefone").mask("(00) 0000-00009", {
	autoclear: !1
});
var allPanels = $(".texto-accordion").hide();
$(".link-accordion").each(function (a, e) {
	$(e).next().find("open").removeClass("open"),
	$(this).on("click", function () {
		return $(this).next().is(":hidden") ? ($(this).addClass("open"), allPanels.slideUp(), $(this).next().slideDown()) : ($(this).removeClass("open"), allPanels.slideUp(), $(this).next().slideUp()),
		!1
	})
});
var mySwiper = new Swiper(".planos-produtos", {
		slidesPerView: 3,
		spaceBetween: 30,
		loop: !1,
		speed: 1200,
	...
	}), tabGradeCanais = new Swiper(".head-abas", {
		slidesPerView: 4,
		spaceBetween: 0,
		speed: 800,
		clickable: !0,
	...
	}), canaisPacote = new Swiper(".canais-pacotes", {
		sync: ".head-abas",
		clickable: !0
	});
$(".canais-pacotes").hasClass("swiper-container") && ((tabGradeCanais.controller.control = canaisPacote).controller.control = tabGradeCanais);
var valfinal = null;
function somaValorFinal() {
	var o = null,
	i = null,
	s = null;
	return $.each($(".rows-price"), function (a, e) {
		var n = $(e).data("pricecombo"),
		t = $(e).data("price");
		o = 0 == a ? (s += t, i += n, t) : (s += t, $(".partirde").addClass("box-partir").html("<span> A partir de: </span> R$ " + numeroParaMoeda(s)), i + n)
	}),
	o
}
function subtraiValorFinal() {
	var o = null,
	i = null;
	$.each($(".rows-price"), function (a, e) {
		var n = $(e).data("pricecombo"),
		t = $(e).data("price");
		o += t,
		0 == a ? ($(".partirde").html(""), $(".valor-final").html(numeroParaMoeda(t))) : (i += n, $(".valor-final").html(numeroParaMoeda(i)), $(".partirde").addClass("box-partir").html("<span> A partir de: </span> R$ " + numeroParaMoeda(o)))
	})
}
function numeroParaMoeda(a, e, n, t) {
	return e = isNaN(e = Math.abs(e)) ? 2 : e,
	n = null == n ? "," : n,
	t = null == t ? "." : t,
	s = a < 0 ? "-" : "",
	i = parseInt(a = Math.abs(+a || 0).toFixed(e)) + "",
	j = 3 < (j = i.length) ? j % 3 : 0,
	s + (j ? i.substr(0, j) + t : "") + i.substr(j).replace(/(\d{3})(?=\d)/g, "$1" + t) + (e ? n + Math.abs(a - i).toFixed(e).slice(2) : "")
}
$.each($(".btn-adiciona-resumo"), function (a, e) {
	console.log($(this)),
	$(this).on("click", function () {
		console.log( $(this).data());
		var a = $(this).data("type"),
		e = $(this).data("nameplan"),
		n = $(this).data("valorplan"),
		t = $(this).data("valorcombo");
		u = $(this).data("valortrip´le");
		
		switch($('.resumo-item').length){
			case 0: vr_display = n;
			case 1: vr_display = t;
			case 2: vr_display = u;
		}
		triple = $(this).data("valortriple");
		$('.btn-adiciona-resumo[data-type="' + a + '"]').attr("disabled", "disabled");
		var o = '<div class="box-contrato resumo-item" data-typeitem="' + a + '" data-count="1">';
		o += '<div class="title">' + e + "</div>",
		o += '<div class="price rows-price" data-price="' + n + '" data-pricecombo="' + t + '" data-pricetriple="' + triple + '" > <span> R$' + numeroParaMoeda(vr_display) + "</span> POR MÊS </div>",
		o += '<div> <a href="#" data-typeremove="' + a + '" data-valorproduto="' + n + '" data-valorCombo="' + t + '"  data-valortriple="' + triple + '" class="btn-exclui-produto" data-produtoId="'+$(this).data('id')+'"> x </a></div>',
		o += "</div>",
		$(o).appendTo(".form-finaliza"),
		valfinal = somaValorFinal(),
		$(".valor-final").html(numeroParaMoeda(valfinal))
	})
}), $(document).on("click", ".btn-exclui-produto", function (a) {
	a.preventDefault();
	var e = $(this).data("typeremove"),
	n = ($(this).data("valorproduto"), $(this).parent().parent().get(0));
	$('.btn-adiciona-resumo[data-type="' + e + '"]').prop("disabled", !1),
	$(n).remove(),
	subtraiValorFinal()
});
var api = "https://api.valenet.com.br/api/districts/";
$(".cidade").change(function (a) {
	a.preventDefault();
	var e = this.options[this.selectedIndex].getAttribute("data-id");
	console.log(e);
	var n = api + e;
	$.ajax({
		dataType: "json",
		url: n,
		success: function (a) {
			$("#distrito").html(" <option disabled selected> Selecione um bairro </option> "),
			$.each(a, function (a, e) {
				$("#distrito").append("<option>" + e.name + "</option>"),
	...
	return $(".pop-up-grade").css("display", "none"),
	!1
}), $(document).on("click", ".pop-up-grade", function () {
	return $(".pop-up-grade").css("display", "none"),
	!1
}), $(".btn-saiba-produto").on("click", function () {
...
var elementoTeste = $(".grupo-lista");
$(elementoTeste).each(function (a, e) {
	"" == $.trim($(e).html()) && (console.log("vazios"), $(e).parent().addClass("apagaLinha"))
}), function (s) {
	function a(a) {
		var e,
		t,
		...
		s.each(e.markers, function (a, e) {
			var n = new google.maps.LatLng(e.position.lat(), e.position.lng());
			t.extend(n)
		}),
		1 == e.markers.length ? (e.setCenter(t.getCenter()), e.setZoom(12)) : e.fitBounds(t),
		i
	}
